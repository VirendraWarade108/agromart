...
import { Search, SlidersHorizontal, Star, ShoppingCart, Heart, LayoutGrid, List, Mic, X, Sparkles, TrendingUp, Package } from 'lucide-react';
...
export default function ProductsPage() {
  ...
  const categories = [
    { id: 'all', name: 'All Products', count: 1500, icon: '📦' },
    ...
    { id: 'tools', name: 'Tools', count: 170, icon: '🔧' }
  ];

  const products = [
    { id: 1, name: 'Premium Hybrid Seeds - Tomato', category: 'seeds', price: 2499, originalPrice: 3124, rating: 4.8, reviews: 234, image: '🍅', inStock: true, discount: 20, sales: 1200, badge: 'Bestseller' },
    { id: 2, name: 'Organic Fertilizer Pro - NPK 10:26:26', category: 'fertilizers', price: 1899, originalPrice: 2234, rating: 4.9, reviews: 456, image: '🌿', inStock: true, discount: 15, sales: 890, badge: 'Top Rated' },
    { id: 3, name: 'Smart Irrigation Kit - Drip System', category: 'irrigation', price: 8999, originalPrice: 11999, rating: 4.7, reviews: 123, image: '💦', inStock: true, discount: 25, sales: 650, badge: 'New' },
    { id: 4, name: 'Power Tiller Machine - 8HP', category: 'equipment', price: 45999, originalPrice: 51110, rating: 4.6, reviews: 89, image: '⚙️', inStock: true, discount: 10, sales: 320 },
    { id: 5, name: 'Bio Pesticide - Neem Based', category: 'pesticides', price: 799, originalPrice: 999, rating: 4.5, reviews: 567, image: '🛡️', inStock: true, discount: 20, sales: 980, badge: 'Bestseller' },
    { id: 6, name: 'Garden Tools Set - 10 Pieces', category: 'tools', price: 1499, originalPrice: 1999, rating: 4.7, reviews: 345, image: '🔧', inStock: true, discount: 25, sales: 720 },
    { id: 7, name: 'Wheat Seeds - HD 3086 Variety', category: 'seeds', price: 3200, originalPrice: 3556, rating: 4.8, reviews: 890, image: '🌾', inStock: true, discount: 10, sales: 1500, badge: 'Top Rated' },
    { id: 8, name: 'Vermicompost Fertilizer - 50kg', category: 'fertilizers', price: 2500, originalPrice: 3125, rating: 4.9, reviews: 234, image: '♻️', inStock: true, discount: 20, sales: 450 },
    { id: 9, name: 'Sprinkler System - Automatic', category: 'irrigation', price: 6499, originalPrice: 8124, rating: 4.6, reviews: 167, image: '🚿', inStock: true, discount: 20, sales: 380 },
    { id: 10, name: 'Rotavator - Heavy Duty', category: 'equipment', price: 32000, originalPrice: 40000, rating: 4.5, reviews: 56, image: '🚜', inStock: false, discount: 20, sales: 120 },
    { id: 11, name: 'Fungicide Spray - 500ml', category: 'pesticides', price: 599, originalPrice: 749, rating: 4.4, reviews: 678, image: '💉', inStock: true, discount: 20, sales: 890 },
    { id: 12, name: 'Pruning Shears - Professional', category: 'tools', price: 899, originalPrice: 1199, rating: 4.8, reviews: 432, image: '✂️', inStock: true, discount: 25, sales: 650, badge: 'New' }
  ];
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-green-500/20 backdrop-blur-xl border-2 border-green-400/40 mb-6 shadow-lg">
              ...
              <span className="text-green-100 font-bold text-sm">PREMIUM QUALITY PRODUCTS</span>
            </div>

            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-white mb-4 leading-tight">
              Our Products
            </h1>
            <p className="text-xl text-gray-200 font-medium max-w-2xl mx-auto mb-8">
          ...
          <div className="grid grid-cols-3 gap-6 max-w-3xl mx-auto">
            {[
              { label: '1500+ Products', icon: Package },
              { label: '50K+ Happy Farmers', icon: Sparkles },
          ...
          <aside className={`lg:w-80 ${showFilters ? 'block' : 'hidden lg:block'}`}>
            ...
            >
              ...
              <div className="mb-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button className="px-3 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg text-sm font-bold">Under ₹1000</button>
                    <button className="px-3 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg text-sm font-bold">₹1K - ₹5K</button>
                    <button className="px-3 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg text-sm font-bold">₹5K - ₹10K</button>
                    <button className="px-3 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg text-sm font-bold">Above ₹10K</button>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 mb-8">
                ...
                <label className="flex items-center gap-3 cursor-pointer group">
                  <input type="checkbox" className="w-5 h-5 text-green-600 rounded border-2 border-gray-300 focus:ring-2 focus:ring-green-500" />
                  <span className="text-gray-700 font-bold group-hover:text-green-600">Free Delivery</span>
                </label>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <p className="text-gray-700 font-bold text-lg">
                    <span className="text-green-600">{sortedProducts.length}</span> Products Found
                  </p>
                </div>
            ...
            <div className={viewMode === 'grid' ? 'grid md:grid-cols-2 xl:grid-cols-3 gap-6' : 'space-y-6'}>
              {sortedProducts.map((product, idx) => (
                ...
                >
                  {/* Badge */}
                  {product.badge && (
                    <div className="absolute top-4 left-4 z-10 px-3 py-1 bg-gradient-to-r from-green-600 to-emerald-600 text-white text-xs font-black rounded-lg shadow-lg">
                      {product.badge}
                    </div>
                  )}
                  ...
                  <div className="p-6 flex-1">
                    ...
                    {/* Stock Status */}
                    {!product.inStock ? (
                      <p className="text-red-600 font-black text-sm mb-4 bg-red-50 px-3 py-2 rounded-lg border border-red-200">
                        ⚠️ Out of Stock
                      </p>
                    ) : (
                      <p className="text-green-600 font-black text-sm mb-4 bg-green-50 px-3 py-2 rounded-lg border border-green-200">
                        ✓ In Stock
                      </p>
                    )}
