...
export default function RegisterPage() {
  ...
  const benefits = [
    { icon: CheckCircle, text: 'Access to 1500+ premium products' },
    { icon: CheckCircle, text: 'Free delivery on orders above ₹5000' },
    { icon: CheckCircle, text: 'Exclusive member-only discounts' },
      ...
      <div className="relative max-w-6xl w-full">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            className="hidden lg:flex flex-col justify-start py-12"
          >
            {/* Logo */}
            ...
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-300 font-medium leading-relaxed">
                Create your account and get access to premium agricultural products, expert advice, and exclusive deals.
              </p>
            </div>
            ...
            <div className="mt-12 grid grid-cols-3 gap-6">
              {[
                ...
                <div key={idx} className="text-center p-4 bg-white/5 backdrop-blur-xl rounded-xl border border-white/10">
                  <p className="text-3xl font-black text-white mb-1">{stat.value}</p>
                  <p className="text-green-300 text-sm font-bold">{stat.label}</p>
                </div>
              ))}
            </div>
          </motion.div>
              ...
              <div className="bg-white rounded-3xl shadow-2xl border-2 border-gray-200 p-8 sm:p-12">
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600 font-semibold">
                    Join thousands of farmers across India
                  </p>
                </div>
                  ...
                  <div>
                    <label className="flex items-start gap-3 cursor-pointer group">
                      ...
                      <span className="text-gray-700 font-semibold text-sm leading-relaxed group-hover:text-gray-900">
                        ...
                        <Link href="#" className="text-green-600 hover:text-green-700 font-bold">
                          Terms of Service
                        </Link>{' '}
                        and{' '}
                        <Link href="#" className="text-green-600 hover:text-green-700 font-bold">
                ...
                <div className="mt-8 p-4 bg-green-50 rounded-xl border-2 border-green-200 flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-green-900 font-bold text-sm">Your data is secure</p>
                    <p className="text-green-700 text-xs font-semibold">We use industry-standard encryption</p>
                  </div>
                </div>
              </div>
            </div>
